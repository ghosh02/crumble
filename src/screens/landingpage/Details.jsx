...
//     const item = {
//       id: `${itemDetails.name}${selectedSize}`,
...
//         }}>
//         <BackBtn />
//         <Text style={{color: '#fff', fontSize: 17, fontFamily: 'Sen-Regular'}}>
//           Details
//         </Text>
//       </View>
//       <ScrollView
...
//           />
//           <Text style={{color: '#181C2E', fontFamily: 'Sen-Regular'}}>
//             CRUMBLE
//           </Text>
//         </View>
//         <Text style={{color: '#181C2E', fontFamily: 'Sen-Bold', fontSize: 20}}>
//           {itemDetails.name}
//         </Text>
//         <Text
//           style={{
...
const Details = ({route}) => {
  ...
  const middleIndex = Math.floor(itemDetails.sizes.length / 2);
  const [selectedSize, setSelectedSize] = useState(
    itemDetails.sizes[middleIndex],
  ); // Automatically select the middle size
  const [quantity, setQuantity] = useState(1);
  ...
  const handleAddToCart = () => {
    const item = {
      id: `${itemDetails.name}${selectedSize.size}`,
      name: itemDetails.name,
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={{flexDirection: 'row', gap: 10}}>
            {itemDetails.sizes.map(size => (
              <TouchableOpacity
                ...
                style={[
                  styles.sizeButton,
                  selectedSize.size === size.size && styles.selectedSizeButton,
                ]}
                onPress={() => handleSizeClick(size)}>
                <Text
                  style={[
      ...
      <View
        ...
        <View style={styles.priceQuantity}>
          <Text style={styles.price}>${selectedSize.price * quantity}</Text>
          <View style={styles.quantityControl}>
            <TouchableOpacity
              style={styles.quantityButtonContainer}
              onPress={handleDecrease}>
